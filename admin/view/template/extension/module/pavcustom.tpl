							...
							<div>
								...
								<div class="tab-pane" id="tab-module-pavcustom-<?php echo $module_row ;?>">
									...
									<ul class="nav nav-tabs" id="language<?php echo $module_row ;?>">
										...
										<li>
											<a href="#tab-module-<?php echo $module_row ;?>-language-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
										</li>
										<?php } ?>
									</ul>
...
$('#pavstores').bind('change', function () {
	url = 'index.php?route=extension/module/pavcustom&token=<?php echo $token; ?>';
	var id = $(this).val();
	if (id) {
...
function addModule() {
	...
	html += '	<ul class="nav nav-tabs" id="language' + module_row + '">';
					<?php foreach ($languages as $language) { ?>
	html += '		<li>';
	html += '			<a href="#tab-module-' + module_row + '-language-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>';
	html += '		</li>';
					<?php } ?>
	html += '	</ul>';
