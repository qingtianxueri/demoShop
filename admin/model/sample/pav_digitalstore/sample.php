...
if( !class_exists("ModuleSample") ) {
	class ModuleSample { 
		...
		public static function getStoreConfigs(){
			return array(
					'theme_default_image_category_width' =>873,
					'theme_default_image_category_height' => 250,
					
					'theme_default_image_thumb_width' =>800,
					'theme_default_image_thumb_height' => 640,
					
					'theme_default_image_popup_width' =>800,
					'theme_default_image_popup_height' => 640,
					
					'theme_default_image_product_width' =>240,
					'theme_default_image_product_height' => 192,
					
					'theme_default_image_additional_width' =>80,
					'theme_default_image_additional_height' => 64,
					
					'theme_default_image_related_width' =>800,
					'theme_default_image_related_height' => 640,
					
					'theme_default_image_compare_width' =>65,
					'theme_default_image_compare_height' => 52,
					
					'theme_default_image_wishlist_width' =>65,
					'theme_default_image_wishlist_height' => 52,
					
					'theme_default_image_cart_width' =>65,
					'theme_default_image_cart_height' => 52,
			);
		}
