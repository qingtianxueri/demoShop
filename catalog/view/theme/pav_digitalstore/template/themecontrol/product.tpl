<?php echo $header;  ?>
<style type="text/css">
	#footer,#powered, .rating,#top, #page > header,#topbar,.products-related,.product-box-bottom{
		display: none;
	}
	.product-info {
	    box-shadow:none;
...
<section id="sidebar-main page-quickview" class="col-md-<?php echo $SPAN[1];?>">
	<div id="content"> 
  ...
  'add': function(product_id) {
    $.ajax({
      ...
      success: function(json) {
        ...
        $('#wishlist-total', window.parent.document).html('<i class="fa fa-heart"></i>' + json['total']);
